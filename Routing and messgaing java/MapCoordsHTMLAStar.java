...
public class MapCoordsHTMLAStar {
    ...
    public static void writePoints(List<IntersectionI> list, String filename , double d) {
        try {
            ...
            out.write("];");
            out.newLine();
            out.write("var RoutePath = new google.maps.Polyline({path: pathPoints,strokeColor: '#0000FF',strokeOpacity: 1.0,strokeWeight: 2});");
            out.newLine();
            out.write("RoutePath.setMap(map);};google.maps.event.addDomListener(window, 'load', initialize);</script></head>");
            out.newLine();
            out.write("  <body>SHORTEST PATH using A*<div id=\"map-canvas\" style=\"width:1200px;height:650px;border:solid black 1px;\"></div><BR> Distance = "+d+"</body></html>");
            out.newLine();
            out.close();
        } catch (IOException e) {
