...
<html>
    ...
    <head>
        <title>Posted Ride | CarPool</title>
...
//         result += parkingCost * noOfDays;
        ...
        <script type="text/javascript">
            var distance = 0;
            var time = 0;
            var stops = [{"Geometry": {"Latitude": <%=request.getParameter("homelat")%>, "Longitude": <%=request.getParameter("homelng")%>}},
                {"Geometry": {"Latitude": <%=request.getParameter("officelat")%>, "Longitude": <%=request.getParameter("officelng")%>}}
            ];
            function initialize() {
                var mapOptions = {
                    zoom: 13,
                ...
                var days = ''+ <%="" + request.getParameter("day1")%>;
                if(days.indexOf("1")>=0){                    
                    document.getElementById('daysof').innerHTML += "Monday ";                    
                }
                days = ''+ <%="" + request.getParameter("day2")%>;
                if(days.indexOf("2")>=0){                    
                    document.getElementById('daysof').innerHTML += "Tuesday ";                    
                }
                days = ''+ <%="" + request.getParameter("day3")%>;
                if(days.indexOf("3")>=0){                    
                    document.getElementById('daysof').innerHTML += "Wednesday ";                    
                }
                days = ''+ <%="" + request.getParameter("day4")%>;
                if(days.indexOf("4")>=0){                    
                    document.getElementById('daysof').innerHTML += "Thursday ";                    
                }
                days = ''+ <%="" + request.getParameter("day5")%>;
                if(days.indexOf("5")>=0){                    
                    document.getElementById('daysof').innerHTML += "Friday ";                    
                }
                days = ''+ <%="" + request.getParameter("day6")%>;
                if(days.indexOf("6")>=0){                    
                    document.getElementById('daysof').innerHTML += "Saturday ";                    
                }
                days = ''+ <%="" + request.getParameter("day7")%>;
                if(days.indexOf("7")>=0){                    
                    document.getElementById('daysof').innerHTML += "Sunday ";                    
                }
            ...
            <div class="col-md-7 col-md-push-1">
                <div class="container">
                    ...
                    <form method="post" action="post.jsp">
                        ...
                        <p id="car1">      CAR  : <%="" + request.getParameter("car")%></p>
                        <p id="fueltype1">      FUEL TYPE  : <%="" + request.getParameter("fueltype")%></p>
                        <p id="carcapacity1">      CAR CAPACITY  : <%="" + request.getParameter("carcapacity")%></p>
                        <p id="daysof">      DAYS  : </p>
                        <p id="stime1">      START TIME  : <%="" + request.getParameter("stime")%></p>
                        <p id="etime1">      END TIME  : <%="" + request.getParameter("etime")%></p>
                        <p id="sdate1">      START DATE  : <%="" + request.getParameter("sdate")%></p>
                        <p id="edate1">      END DATE  : <%="" + request.getParameter("edate")%></p>
                        <table>
                            <tr>
                                <td> 
                                    <div id="map-canvas" style="width:740px;height:520px;"></div>
                                </td>
                                <td>
                        ...
                        <input type="hidden" name="fueltype" value="<%="" + request.getParameter("fueltype")%>"/>
                        <input type="hidden" name="carcapacity" value="<%="" + request.getParameter("carcapacity")%>"/>
                        ...
                        <input type="hidden" name="edate" value=" <%="" + request.getParameter("edate")%>"/>                                               
                        <input type="hidden" name="homelat" value="<%="" + request.getParameter("homelat")%>"/>
                        <input type="hidden" name="officelat" value="<%="" + request.getParameter("officelat")%>"/>
                        <input type="hidden" name="homelng" value="<%="" + request.getParameter("homelng")%>"/>
                        <input type="hidden" name="officelng" value="<%="" + request.getParameter("officelng")%>"/>
                        <input type="hidden" name="officelng" value="<%="" + request.getParameter("officelng")%>"/>
                        ...
                        <input type="hidden" name="day3" value="<%="" + request.getParameter("day3")%>"/> 
                        <input type="hidden" name="day4" value="<%="" + request.getParameter("day4")%>"/> 
                        <input type="hidden" name="day5" value="<%="" + request.getParameter("day5")%>"/> 
                        <input type="hidden" name="day6" value="<%="" + request.getParameter("day6")%>"/> 
                        <input type="hidden" name="day7" value="<%="" + request.getParameter("day7")%>"/> 
                        

                        <button type="submit" class="btn btn-lg btn-success">
                            <i class="glyphicon glyphicon-check"></i>&nbsp;&nbsp;Save Post Ride
                        </button>
                        <button type="button" id="cancel" class="btn btn-lg btn-warning" onclick="window.location.href='welcome.jsp'">
