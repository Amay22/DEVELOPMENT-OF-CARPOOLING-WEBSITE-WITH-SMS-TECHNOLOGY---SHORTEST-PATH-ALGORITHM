...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function load(url,callback) {
                document.getElementById("delbutt").onclick = function() {
                    location.href = "DeleteRide.jsp?butt=" + butt;
                };
                document.getElementById("view1").onclick = function() {
                    location.href = "GetForViewing.jsp?butt=" + v;
                };
                var xmlhttp;
              ...
              window.onload = function () {
                ...
                load('GetPostedandMemberRides.jsp',function(response){
                  document.getElementById("posted").innerHTML = response;
                });
        ...
        <% int dele = request.getParameter("del") == null ? 0 : Integer.parseInt(("" + request.getParameter("del")).trim());
            if (dele == 1) {
        %>
        <script type="text/javascript">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>                                    
                                    <a href="#" data-toggle="modal" data-target="#CostCalc"><i class="glyphicon glyphicon-calculator"></i>Cost Calculator</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Delete Car Pool !</h4>
                    </div>
                    <div class="modal-body">
                        <p>Are you sure you wanna Delete this Car Pool Ride and Group?</p>
                        <button id="delbutt" class="btn btn-success btn-lg" data-dismiss="modal"><i class="glyphicon glyphicon-ok-sign"></i>&nbsp;&nbsp;YES</button>
                        <button type="button" class="btn btn-default btn-lg" data-dismiss="modal"><i class="glyphicon glyphicon-remove-sign"></i>&nbsp;&nbsp;NO</button>
                    </div>      
                </div>
            </div>
        </div>  
        <div class="modal fade" id="DeletedModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="glyphicon glyphicon-remove"></i></button>
                        <h4 class="modal-title" id="myModalLabel">Deleted Car Pool !</h4>
                    </div>
                    <div class="modal-body">
                        <p>The Car Pool Group and Ride Has Been Deleted !!!</p>
        ...
        <div class="modal fade" id="ViewModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Do you wanna see this Car Pool Ride and Group?</p>
                        <button id="view1" class="btn btn-success btn-lg" data-dismiss="modal"><i class="glyphicon glyphicon-ok-sign"></i>&nbsp;&nbsp;YES</button>
                        <button type="button" class="btn btn-default btn-lg" data-dismiss="modal"><i class="glyphicon glyphicon-remove-sign"></i>&nbsp;&nbsp;NO</button>
                    </div>      
                </div>
            </div>
