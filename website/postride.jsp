                ...
                <div class="container">
                    ...
                    <form onsubmit="return invalidateChecks()" method="post" action="PostedRide.jsp">
                        ...
                        <div class="row">
                            <div class="form-group col-md-7 ">
                                <select name="car" class="form-control"  required>
                                    ...
                                    <option value="47">Bugatti</option>
                                    <option value="52">Caterham</option>
                                    <option value="2">Chevrolet</option>
                                    <option value="33">Ferrari</option>
                                    <option value="4">Fiat</option>
                                    <option value="50">Force Motors</option>
                                    <option value="5">Ford</option>
                                    <option value="6">Hindustan Motors</option>
                                    <option value="7">Honda</option>
                                    <option value="8">Hyundai</option>
                                    <option value="38">ICML</option>
                                    <option value="44">Jaguar</option>
                                    <option value="30">Lamborghini</option>
                                    <option value="23">Land Rover</option>
                                    <option value="9">Mahindra</option>
                                    <option value="10">Maruti Suzuki</option>
                                    ...
                                    <option value="14">Premier</option>
                                    <option value="45">Renault</option>
                                    <option value="25">Rolls-Royce</option>
                        ...
                        <div class="row">
                            <div class="form-group col-md-7">
                               <p> Fuel Type:</p>
                                <input checked name="fueltype" type="radio" value="Petrol" id="Petrol" class="radio-inline"><label for="Petrol">Petrol</label></input>
                                <input name="fueltype" type="radio" id="Diesel"  value="Diesel" class="radio-inline"><label for="Diesel">Diesel</label></input>
                                <input name="fueltype" type="radio" id="CNG"  value="CNG" class="radio-inline"><label for="CNG">CNG</label></input>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-7">
                                Capacity of Car:<BR>
                                <input checked name="carcapacity" type="radio" value="2" id="carcap2" class="radio-inline"><label for="carcap2">2</label></input>
                                <input name="carcapacity" type="radio" value="3" id="carcap3" class="radio-inline"><label for="carcap3">3</label></input>
                                <input name="carcapacity" type="radio" value="4" id="carcap4" class="radio-inline"><label for="carcap4">4</label></input>
                                <input name="carcapacity" type="radio" value="5" id="carcap5" class="radio-inline"><label for="carcap5">5</label></input>
                                <input name="carcapacity" type="radio" value="6" id="carcap6" class="radio-inline"><label for="carcap6">6</label></input>
                                <input name="carcapacity" type="radio" value="7" id="carcap7" class="radio-inline"><label for="carcap7">7</label></input>
                                <input name="carcapacity" type="radio" value="8" id="carcap8" class="radio-inline"><label for="carcap8">8</label></input>
                                <input name="carcapacity" type="radio" value="9" id="carcap9" class="radio-inline"><label for="carcap9">9</label> </input>                 
                            </div>
                        </div>
                        <table>
                            <tr><td>
                                    <div class="row">
                                        <div class="form-group col-md-12 ">
                                            <input  type="text" id="stime" name="stime" class="form-control" placeholder="Start Time" onkeypress="return backspaceAll(event)" required/>
                                            <script>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 ">
                                            <input  type="text" id="etime" name="etime" class="form-control" placeholder="End Time" onkeypress="return backspaceAll(event)" required/>
                                            <script>
                                                $(document).ready(function() {
                                                    $('#etime').timepicker({
                                                        showAnim: 'blind'
                        ...
                        <table>
                            <tr><td>
                                    <div class="row">
                                        <div class="form-group col-md-12 ">
                                            <input type="text" name="sdate" id="sdate" placeholder="Start Date" class="form-control" onkeypress="return backspaceAll(event)" required/>                    
                                        </div>
                                    </div>
                                </td><td>
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <input type="text" name="edate" id="edate" placeholder="End Date" class="form-control" onkeypress="return backspaceAll(event)" required/>                    
                                        </div>
                                    </div>
                                </td></tr>
                        </table>
                        <p>Select days:</p>
                        <input class="checkbox-inline" name="day1" onchange="return invalidateChecks()" type="checkbox" id="inlineCheckbox1" value="1"><label for="inlineCheckbox1">Monday</label>
                        <input class="checkbox-inline" name="day2" onchange="return invalidateChecks()" type="checkbox" id="inlineCheckbox2" value="2"><label for="inlineCheckbox2">Tuesday</label>
                        <input class="checkbox-inline" name="day3" onchange="return invalidateChecks()" type="checkbox" id="inlineCheckbox3" value="3"><label for="inlineCheckbox3">Wednesday</label>
                        <input class="checkbox-inline" name="day4" onchange="return invalidateChecks()" type="checkbox" id="inlineCheckbox4" value="4"><label for="inlineCheckbox4">Thursday</label>
                        <input class="checkbox-inline" name="day5" onchange="return invalidateChecks()" type="checkbox" id="inlineCheckbox5" value="5"><label for="inlineCheckbox5">Friday</label>
                        <input class="checkbox-inline" name="day6" onchange="return invalidateChecks()" type="checkbox" id="inlineCheckbox6" value="6"><label for="inlineCheckbox6">Saturday</label>      
                        <input class="checkbox-inline" name="day7" onchange="return invalidateChecks()" type="checkbox" id="inlineCheckbox7" value="7"><label for="inlineCheckbox7">Sunday</label>
                        <BR>                        
