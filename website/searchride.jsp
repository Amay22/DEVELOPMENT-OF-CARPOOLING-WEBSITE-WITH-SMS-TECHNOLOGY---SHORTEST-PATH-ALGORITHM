...
<html>
    <head>
        <title>Search Ride | CarPool</title>
        ...
        <div class="row">
            ...
            <div class="col-md-7 col-md-push-1">
                <div class="container">
                    ...
                    <h3>Search ride</h3>
                    <form onsubmit="return invalidateChecks();" method="post" action="SearchedRides.jsp" >                        
                        <table>
                            <tr><td>
                                    <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group col-md-7 ">
                                <input  type="text" id="stime" name="stime" class="form-control" placeholder=" Time" onkeypress="return backspaceAll(event)" required/>
                                <script>
