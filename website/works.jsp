...
//         result += parkingCost * noOfDays;
    ...
    <body>
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    ...
                    </ul><%if (session.getAttribute("userID") != null) {%>
        ...
        <br><div class="row">
            ...
            <%}%>
            <div class="col-md-<% if (session.getAttribute("userID") != null) {%>9<%} else {%>12<%}%>">
                <div class="container">
                    <!-- Example row of columns -->
                    <div class="row">
                        <div class="col-md-4">
                            <h2>Step 1: Register</h2>
                            <p>Register as car-owner or commuter. Car-owner can switch role as a commuter anytime.</p>
                        </div>
                        <div class="col-md-4">
                            <h2>Step 2: Update Travel</h2>
                            <p>Update the travel details just once and call us to know the carpooling status.</p>
                        </div>
                        <div class="col-md-4">
                            <h2>Step 3: Get Allocations</h2>
                            <p>Start carpooling within a week. (Subjected to availability)</p>
                        </div>        
                    </div><hr>
                    <div class="row">
                        <div class=col-md-4>
                            <h2>Carpooling Process : </h2>
                            <ul>
                                <li>You just need to update your travel details once.</li>
                                <li>Start carpooling within a week.</li>
                                <li>Receive booking SMS everyday.</li>
                                <li>Want to change your timings, call us 8411-933-133,we will provide alternate options.</li>
                            </ul>
                        </div>
                        <div class=col-md-4>
                            <h2>How should I pay ?</h2>
                            <p>Do not worry about paying by cash. The travel and service charges will be transfered from commuter's account to carowner's account online. No need to pay anything until you start carpooling.</p>
                        </div>
                        <div class=col-md-4>
                            <h2>Important points:</h2>
                            <ul>
                                <li>Only email Ids of employees of listed companies are acceptable.</li>
                                <li>If your email id is not accepted, please drop us feedback.</li>
                                <li>Only service-related SMSes or emails are sent.</li>
                                <li>Deposit can be withdrawn anytime</li>
                            </ul>
                        </div>
