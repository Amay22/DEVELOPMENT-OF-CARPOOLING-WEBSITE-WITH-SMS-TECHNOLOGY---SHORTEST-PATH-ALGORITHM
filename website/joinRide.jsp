...
//         result += parkingCost * noOfDays;
        ...
        <script type="text/javascript">
            ...
            var stops = [{"Geometry": {"Latitude": <%=request.getParameter("sourceLat")%>, "Longitude": <%=request.getParameter("sourceLng")%>}},
                {"Geometry": {"Latitude": <%=request.getParameter("homelat")%>, "Longitude": <%=request.getParameter("homelng")%>}},
                    ...
                    <form method="post" action="join.jsp">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <div id="directionsPanel" style="width:300px;max-height:550px;overflow-y:scroll"></div>
                        ...
                        <input type="hidden" id="points" name="points" value="<%="" + request.getParameter("points")%>"/>
                        <input type="hidden" id="gid" name="gid" value="<%="" + request.getParameter("id")%>"/>
                        <input type="hidden" id="members" name="members" value="<%="" + request.getParameter("members")%>"/>
                        <input type="hidden" id="distance1" name="distance1"/>
                        <input type="hidden" id="time1" name="time1"/>
                        <button type="submit" class="btn btn-lg btn-success">
                            Join Ride
                        </button>
                        <button type="button" id="cancel" class="btn btn-lg btn-warning" onclick="window.location.href='SearchedRides.jsp?go=1&homelat=<%="" + request.getParameter("homelat")%>&homelng=<%="" + request.getParameter("homelng")%>&officelat=<%="" + request.getParameter("officelat")%>&officelng=<%="" + request.getParameter("officelng")%>&days=<%="" + request.getParameter("days")%>&stime=<%="" + request.getParameter("usertime")%>'">
                            Go Back
                        </button>                                                 
                    </form>
                            <hr><footer><center>
