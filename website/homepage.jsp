<html>
        ...
        <script type="text/javascript">
            function load(url,callback) {
              ...
              window.onload = function (){
                load('GetHits.jsp',function(response){
    ...
    <body style="background: url('bg.jpeg') no-repeat fixed center;background-size:100%;">
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="container">
                ...
                <br><br>
        <div class="timeNow">                      
            <center><div id="retroclock"><h3>TIME</h3></div></center>
        </div>
                
                <br><br>
                <div id ="response"></div>
                <center><table><tr>
                        <td style="width:250px;"><center><div id="us"><h3>ACTIVE USERS</h3></div></center></td>
                        <td style="width:250px;"><center><div id="hi"><h3>PAGE HITS</h3></div></center></td>
                         <td style="width:250px;"><center><div id="gr"><h3>Groups</h3></div></center></td>
                         </tr></table></center>                                        
                <script>                
                $('#retroclock').flipcountdown({});
                 $('#hi').flipcountdown({ size:"lg",tick:function(){
			return parseInt(document.getElementById("hits").value);
                    }});
                
                </script> 
                <script> 
                    $('#gr').flipcountdown({size:"lg",tick:function(){
			return parseInt(document.getElementById("groups").value);
                    }});                
                </script> 
                <script>                    
                $('#us').flipcountdown({size:"lg",tick:function(){
			return parseInt(document.getElementById("user").value);
                    }});
                </script> 
        <br><br><br>
        <div class="container">
            <h1 style="background:black;color:white;"><center>TRAVEL AT VERY LOW COST TO OFFICE/COLLEGE </center><center> CAR POOLING SERVICE IS HERE !</center><marquee><center><em>redefine your travel experience</em></center></marquee>
            </h1>
