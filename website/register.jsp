...
<html>    
    <head>
        ...
        <script type="text/javascript">
            ...
            function verify() {
                ...
                reqObj.open("GET", "CheckIfEmailExists.jsp?val=" + document.getElementById("emailcheck").value, true);
                reqObj.send();
            }
            function process() {
    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="container">
                    <form onsubmit ="getVal()" method="post" action="registration.jsp">
                       <center> <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;REGISTER HERE...</h1></center>
                        <div class="row">
                            <div class="form-group col-md-8 col-md-push-5">
                                <input name="first" type="text" placeholder="First Name" class="form-control" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-8 col-md-push-5">
                                <input name="last" type="text" placeholder="Last Name" class="form-control" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-8 col-md-push-5">
                        ...
                        <div class="row">
                            <div class="form-group col-md-8 col-md-push-5">
                                <input name="pass1" id="pass1" type="password" placeholder="Password" class="form-control" onchange="checkPass();" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-8 col-md-push-5">
                                <input type="password" name="pass2" id="pass2" placeholder="Confirm Password" class="form-control" required onchange="checkPass();">
                        ...
                        <div class="row">
                            <div class="form-group col-md-8 col-md-push-5">
                                <input name="HouseNo" type="text" placeholder="House No. & Building Name" class="form-control" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-8 col-md-push-5">
                                <div id="map-canvas" style="width:530px;height:480px;"></div>
                                <input required name="pac-input" id="pac-input" class="form-control controls" type="text" onkeypress="return disableEnterKey(event)" placeholder="Enter a location" title="Enter your location here or select on map below"  autocomplete="off"/>
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-push-5 form-group">      
                        ...
                        <div class="row">                        
                            <div class="form-group col-md-8 col-md-push-5">
                                <input required name="mobile" type="tel" onkeypress="return backspaceAlpha(event)" placeholder="Your Mobile No." class="form-control" maxlength="10">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-8 col-md-push-5">
                                <input type="text" name="datepicker" id="datepicker" placeholder="Date Of Birth" class="form-control" onkeypress="return backspaceAll(event)" required/>                    
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-8 col-md-push-5">
                                <input checked name="gender" type="radio" value="m" id="male" class="radio-inline"><label for="male">Male</label>
                                <input name="gender" type="radio" value="f" id="female" class="radio-inline"><label for="female">Female</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-8 col-md-push-5">
                                <input name="image" id="image" type="file" placeholder="Photo" class="form-control" onchange="ReadImg()">
                                <img id = "img1" name ="img1" />
                            </div>
                        </div>             

                        <div class="row">
                            <button class="btn btn-default col-md-8 col-md-push-5 btn-lg btn-success" type="submit">Register and Start CarPooling&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-exclamation-sign"></i></button>
                        </div>  
